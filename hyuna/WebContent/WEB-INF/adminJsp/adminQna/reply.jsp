...
<script type="text/javascript">	
	$(function(){		
		/* 기본 덧글 목록 불러오기 */
		var nim = "<c:out value='${sessionScope.admin }'/>";
		...
		$("#replyInsert").click(function(){			
				var insertUrl = "/adminQna/qnaReply/replyInsert.do";				
				$.ajax({
					url : insertUrl,
					type : "post",
					headers : {
		...
		$(document).on("click", ".update_btn", function(){			
			...
			var qna_reply_content = $("#content").val();
				...
				$.ajax({
					url : '/adminQna/qnaReply/'+qna_reply_no+".do",
					type : "put",
					headers : {
						"Content-Type":"application/json",
	...
	function listAll(qna_no){
		$("#comment_list").html("");
		var url = "/adminQna/qnaReply/all/"+qna_no+".do";
		$.getJSON(url, function(data){
			console.log(data.length);
			
			$(data).each(function(){
				var qna_reply_no = this.qna_reply_no;
				var qna_reply_writer = this.qna_reply_writer;
