...
<script type="text/javascript">
	...
	function addNewItem(color_no, color_detail) {
		new_select.append($('<option value="'+ color_no +'">' + color_detail
				+ '</option>'));
	...
	<div class="single-product-area">
		<div class="container">
			<div class="row">
				...
				<!-- color option가져오는부분 -->
				<form id="colorSelect">
					<input type="hidden" id="model_nol" name="model_nol" /> <input
						type="hidden" id="prd_nol" name="prd_nol" value="${detail.prd_no}" />
				</form>

				<form id="addCartVal">
					<input type="hidden" id="cart_quantity" name="cart_quantity" /> <input
						type="hidden" id="model_no" name="model_no" /> <input
						type="hidden" id="color_no" name="color_no" /> <input
						type="hidden" id="prd_no" name="prd_no" value="${param.prd_no}" />
				...
				<div class="row">
					<div class="col-sm-6 ">
						<div class="product-images">
							...
							<div class="product-main-img">
								...
								<img src="/main/${detail.img_1 }" alt="" class="center-block" style="height: auto; width: 40%;" id="dimg1">
							</div>
					</div>
					<div class="product-inner">
						...
						<div class="product-inner-price">
							...
							<ins>
								<fmt:formatNumber value="${detail.prd_saleprice}"
									type="currency" currencySymbol="￦" />
							</ins>
							<del>
								<fmt:formatNumber value="${detail.prd_orgprice}" type="currency"
									currencySymbol="￦" />
							</del>
						...
						<form action="" class="cart">
							<div class="quantity" style="float: left; border: 1px;">
								<input type="number" size="4" class="input-text qty text"
									...
									id="quantity">
								<button class="add_to_cart_button" type="button" id="addCart">Add
									to cart</button>
							</div>
					...
					<div role="tabpanel" style="margin-top: 30px;">
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home">
								...
								<img src="/detail/${detail.img_3 }" class="center-block" id="dimg3"/>
							</div>
							<!-- review 부분 -->
